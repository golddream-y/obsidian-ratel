...
export interface GoalStrings {
  ...
  'goal.chip.singlePending': string;
  'goal.chip.multiPending': string;
  'goal.chip.takeoverConfirmTitle': string;
  'goal.chip.takeoverConfirmBody': string;
  'goal.modal.create.title': string;
  'goal.modal.create.objective': string;
  'goal.modal.create.criteria': string;
  'goal.modal.create.predicateGlob': string;
  'goal.modal.create.predicateProperty': string;
  'goal.modal.create.maxRounds': string;
  'goal.modal.create.grant': string;
  ...
  'goal.modal.confirm.cancelTitle': string;
  'goal.modal.confirm.cancelBody': string;
  'goal.modal.confirm.completeTitle': string;
  'goal.modal.confirm.completeBody': string;
  'goal.modal.terminal.completedTitle': string;
  'goal.modal.terminal.cancelledTitle': string;
  'goal.modal.terminal.body': string;
  ...
  'goal.settings.rowMeta': string;
  'goal.settings.blockedReason': string;
  'goal.settings.pause': string;
  'goal.settings.resume': string;
  'goal.settings.cancel': string;
  'goal.settings.archive': string;
  'goal.settings.archiveAll': string;
  'goal.settings.archiveAllDesc': string;
  'goal.settings.archiveConfirmTitle': string;
  'goal.settings.archiveConfirmBody': string;
  'goal.settings.archiveAllConfirmTitle': string;
  'goal.settings.archiveAllConfirmBody': string;
  'goal.settings.status.pending': string;
  'goal.settings.status.active': string;
  'goal.settings.status.paused': string;
  'goal.settings.status.blocked': string;
  'goal.settings.status.completed': string;
  'goal.settings.status.cancelled': string;
  'goal.notice.completed': string;
  'goal.notice.corrupt': string;

...
export interface SettingsStrings {
  ...
  'settings.toolPermissions.update_plugin': string;
  'settings.toolPermissions.uninstall_plugin': string;
  'settings.toolPermissions.configure_plugin': string;
  'settings.toolPermissions.get_plugin_status': string;
...
export interface ChatStrings {
  ...
  'chat.slashMenu.tag.command': string;
  'chat.slashMenu.tag.skill': string;
  'chat.slashMenu.origin.builtin': string;
  'chat.slashMenu.origin.installed': string;
  'chat.slashMenu.skillRunModel': string;
...
export interface ToolNameStrings {
  ...
  'tool.name.update_plugin': string;
  'tool.name.uninstall_plugin': string;
  'tool.name.configure_plugin': string;
  'tool.name.get_plugin_status': string;
  'tool.name.get_plugin_status_all': string;
...
export interface PromptLabelStrings {
  ...
  'promptLabel.tool.update_plugin.description': string;
  'promptLabel.tool.update_plugin.description.desc': string;
  'promptLabel.tool.update_plugin.param.pluginId': string;
  'promptLabel.tool.update_plugin.param.pluginId.desc': string;
  'promptLabel.tool.uninstall_plugin.description': string;
  'promptLabel.tool.uninstall_plugin.description.desc': string;
  'promptLabel.tool.uninstall_plugin.param.pluginId': string;
  'promptLabel.tool.uninstall_plugin.param.pluginId.desc': string;
  'promptLabel.tool.configure_plugin.description': string;
  'promptLabel.tool.configure_plugin.description.desc': string;
  'promptLabel.tool.configure_plugin.param.pluginId': string;
  'promptLabel.tool.configure_plugin.param.pluginId.desc': string;
  'promptLabel.tool.configure_plugin.param.op': string;
  'promptLabel.tool.configure_plugin.param.op.desc': string;
  'promptLabel.tool.configure_plugin.param.patch': string;
  'promptLabel.tool.configure_plugin.param.patch.desc': string;
  'promptLabel.tool.get_plugin_status.description': string;
  'promptLabel.tool.get_plugin_status.description.desc': string;
  'promptLabel.tool.get_plugin_status.param.pluginId': string;
  'promptLabel.tool.get_plugin_status.param.pluginId.desc': string;
  'promptLabel.tool.get_plugin_status.param.includeKeys': string;
  'promptLabel.tool.get_plugin_status.param.includeKeys.desc': string;
  'promptLabel.tool.get_plugin_status.param.checkUpdate': string;
  'promptLabel.tool.get_plugin_status.param.checkUpdate.desc': string;
  'promptLabel.tool.list_ecosystem_changes.description': string;
  'promptLabel.tool.list_ecosystem_changes.description.desc': string;
  'promptLabel.tool.list_ecosystem_changes.param.pluginId': string;
  'promptLabel.tool.list_ecosystem_changes.param.pluginId.desc': string;
  'promptLabel.tool.list_ecosystem_changes.param.limit': string;
  'promptLabel.tool.list_ecosystem_changes.param.limit.desc': string;
  'promptLabel.tool.restore_backup.description': string;
  'promptLabel.tool.restore_backup.description.desc': string;
  'promptLabel.tool.restore_backup.param.changeId': string;
  'promptLabel.tool.restore_backup.param.changeId.desc': string;
  'promptLabel.tool.apply_diary_host.description': string;

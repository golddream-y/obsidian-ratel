/**
 * @file src/ui/motion/empty/line-waves-shaders.ts
 * @description Line Waves 背景 WebGL2 着色器（保留上游数学，仅升级 GLSL 语法）
 * @module ui/motion/empty/line-waves-shaders
 * @origin https://github.com/DavidHDev/react-bits/blob/main/src/ts-default/Backgrounds/LineWaves/LineWaves.tsx
 */

/** 全屏三角顶点着色器 */
export const LINE_WAVES_VERT = `#version 300 es
in vec2 position;
void main() {
...
/** Line Waves 片元着色器 */
export const LINE_WAVES_FRAG = `#version 300 es

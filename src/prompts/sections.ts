...
function buildSections(): SectionMeta[] {
	return [
		...
		// --- tool.write_skill_draft ---
		{
			id: 'tool.write_skill_draft.description',
			label: tNow('promptLabel.tool.write_skill_draft.description'),
			description: tNow('promptLabel.tool.write_skill_draft.description.desc'),
			zone: 'tool',
			placeholders: [],
			allowOverride: true,
		},
		{
			id: 'tool.write_skill_draft.param.name',
			label: tNow('promptLabel.tool.write_skill_draft.param.name'),
			description: tNow('promptLabel.tool.write_skill_draft.param.name.desc'),
			zone: 'tool',
			placeholders: [],
			allowOverride: true,
		},
		{
			id: 'tool.write_skill_draft.param.description',
			label: tNow('promptLabel.tool.write_skill_draft.param.description'),
			description: tNow('promptLabel.tool.write_skill_draft.param.description.desc'),
			zone: 'tool',
			placeholders: [],
			allowOverride: true,
		},
		{
			id: 'tool.write_skill_draft.param.instructions',
			label: tNow('promptLabel.tool.write_skill_draft.param.instructions'),
			description: tNow('promptLabel.tool.write_skill_draft.param.instructions.desc'),
			zone: 'tool',
			placeholders: [],
			allowOverride: true,
		},
		{
			id: 'tool.write_skill_draft.param.ecosystem',
			label: tNow('promptLabel.tool.write_skill_draft.param.ecosystem'),
			description: tNow('promptLabel.tool.write_skill_draft.param.ecosystem.desc'),
			zone: 'tool',
			placeholders: [],
			allowOverride: true,
		},
		{
			id: 'tool.write_skill_draft.param.overwrite',
			label: tNow('promptLabel.tool.write_skill_draft.param.overwrite'),
			description: tNow('promptLabel.tool.write_skill_draft.param.overwrite.desc'),
			zone: 'tool',
			placeholders: [],
			allowOverride: true,
		},

...
> 关联: [S-ECOSYSTEM](2026-08-20-ecosystem-management-design.md)（执行层全量）、[S-PLUGIN-PROFILE](2026-09-10-plugin-profile-design.md)（档案与 PP-08）、[S-HOST-ACCESS](2026-09-11-host-access-design.md)（不借道放宽沙箱）、[prd/ecosystem.md](../../prd/ecosystem.md)、[ADR-014](../../adr/2026-08-03-mcp-host-platform.md)、ADR-018（生态出站，**未立本 spec 不得当产品闸已过**）
...
- [S-HOST-ACCESS](2026-09-11-host-access-design.md)

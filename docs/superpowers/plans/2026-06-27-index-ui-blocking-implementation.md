...
- [x] **Step 1: 写失败测试 — upsertItem 写入预计算向量**
...
- [x] **Step 3: 修改 IndexProcessor — 构造函数 + indexIncremental**
...
- [x] **Step 4: 修改 indexFull — 同样改为批量 embed**
...
- [x] **Step 1: 修改 handler.ts — initProcessorWithStore 新增 embeddings 参数**
...
- [x] **Step 2: 修改 inline-worker.ts — initWithStore 新增 embeddings 参数**
...
- [x] **Step 3: 更新 handler.test.ts 中的 initProcessorWithStore 调用**
...
- [x] **Step 1: 写失败测试 — init 完成 + embed 请求/响应**
...
- [x] **Step 3: 实现 EmbeddingWorkerProxy**
...
- [x] **Step 1: 写失败测试 — init ready + embed 返回向量**
...
- [x] **Step 3: 实现 embedding-worker.ts**
...
- [x] **Step 1: 新增 embeddingWorkerContext**
...
- [x] **Step 2: 在 prod/watch 分支中添加 embeddingWorkerContext**
...
- [x] **Step 1: 修改 main.ts — 创建 EmbeddingWorkerProxy**

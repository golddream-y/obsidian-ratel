...
- [x] **Step 1: 检查是否已有 `applyContextLengthPreset`**
...
- [x] **Step 4: 实现 `applyContextLengthPreset` 并接线 `setControlValue`**
...
- [x] **Step 3: 实现 `src/ui/settings-store.ts`**
...
- [x] **Step 1: 替换 import 与 save/load 挂钩**
...
- [x] **Step 1: 将 P-SETTINGS-SYNC 标为 Completed（执行结束时）**

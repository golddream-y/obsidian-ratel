...
| ID | 文件 | 状态 | 所属 Spec | 备注 |
|---|---|---|---|---|
| P-CHAT-MOTION | [2026-08-12-chat-motion-bits.md](plans/2026-08-12-chat-motion-bits.md) | 🔄 In Progress | S-CHAT-MOTION | 分支 feat/p-chat-motion；Task 1 prefs+settings+i18n 完成 |

...
| ID | 文件 | 状态 | 创建日期 | 备注 |
|---|---|---|---|---|
| S-COMPACT-V2 | [2026-08-13-compact-v2-design.md](specs/2026-08-13-compact-v2-design.md) | Active | 2026-08-13 | 投影压缩不改聊天记录；microcompact + 标记摘要 + 自动压 + PTL 重试 1 次 |
...
| ID | 文件 | 状态 | 所属 Spec | 备注 |
|---|---|---|---|---|
| P-COMPACT-V2 | [2026-08-13-compact-v2.md](plans/2026-08-13-compact-v2.md) | ✅ Completed | S-COMPACT-V2 | 分支 feat/p-compact-v2 squash 合入 develop；投影压缩；7 Task |

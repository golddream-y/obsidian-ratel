...
### Fixed
- **社区商店发版验签** — 修复商店对发布包验签失败的问题（0.1.10 / 0.1.11 可能仍报签名无效，请升到本版）
- **商店源码检查告警减少** — 外观设置页与调试日志写法对齐商店建议

---

## [0.1.11] - 2026-07-17

> 发版验签的中间版本，功能与 0.1.10 相同；完整修复见 0.1.12。
...
### Fixed
- **若干商店源码检查告警** — 主题名校验、无用 await、调试日志默认更安静等
